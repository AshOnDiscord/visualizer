export const CLUSTER_PALETTE = [
  '#4F6EF7', '#E8564A', '#2EC4B6', '#F5A623', '#9B5DE5',
  '#00B4D8', '#F72585', '#3A86FF', '#06D6A0', '#FB8500',
  '#8338EC', '#FF006E', '#3D405B', '#E07A5F', '#81B29A',
  '#F2CC8F', '#118AB2', '#073B4C', '#FFD166', '#EF476F',
];
...
export function densityToRGB(
  ...
  if (darkMode) {
    ...
    const br = 0.02, bg_ = 0.02, bb = 0.04; // dark navy floor
    return [
      r * t + br * (1 - t),
      g * t + bg_ * (1 - t),
      b * t + bb  * (1 - t),
